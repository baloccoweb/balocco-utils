...
const CHROME_HEADERS = {
    ...
    'user-agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/${CHROME_BUILD} Safari/537.36',
...
const HeadersHelper = {
    getRealChrome: (locale) => {
        ...
        newHeaders["user-agent"] = newHeaders["user-agent"]
            .replaceAll("${CHROME_BUILD}", chomeVersion[1]);
